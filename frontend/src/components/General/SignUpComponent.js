...
function SignUpComponent(props) {
  ...
  return (
    <div className={classes.usersignUpRoot}>
      <Paper
        className={`${classes.signUpPaper} ${extendedClasses.roundBox} ${extendedClasses.borderBox} ${extendedClasses.shadow}`}
        component="form"
      >
        <div className={classes.signUpRow}>
          <Typography variant="h4" align="center">
            Sign up for Inspectra!
          </Typography>
        </div>
        <div className={classes.signUpRow}>
          <TextField
